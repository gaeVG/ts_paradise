import { ISkin } from "../../../core/types/user";
...
class Skin {
    ...
    constructor(skinId : number, skinName : string, skinDescription : any, skinPrice : number, skinImage) {
        this.skinId = skinId;
    ...
    applySkin(skin : ISkin, clothes? : any) : void {
		...
		SetPedHeadBlendData(playerPed, this.character.mom, this.character.dad, 0, this.character.mom, this.character.dad, 0, face_weight, skin_weight, 0.0, false)
		...
		SetPedHeadOverlay(playerPed, 0,	this.character.blemishes_1,	(this.character.blemishes_2 / 10) + 0.0)
		...
		SetPedHeadOverlay(playerPed, 2,	this.character.eyebrows_1, (this.character.eyebrows_2 / 10) + 0.0)
		SetPedHeadOverlay(playerPed, 4,	this.character.makeup_1, (this.character.makeup_2 / 10) + 0.0)
		SetPedHeadOverlay(playerPed, 8,	this.character.lipstick_1, (this.character.lipstick_2 / 10) + 0.0)
		...
		SetPedHeadOverlay(playerPed, 6,	this.character.complexion_1, (this.character.complexion_2 / 10) + 0.0)
		...
		this.character.bodyb_1 === -1 ? SetPedHeadOverlay(playerPed, 11, 255, (this.character.bodyb_2 / 10) + 0.0) : SetPedHeadOverlay(playerPed, 11, this.character.bodyb_1, (this.character.bodyb_2 / 10) + 0.0)
		this.character.bodyb_3 === -1 ? SetPedHeadOverlay(playerPed, 12,	255, (this.character.bodyb_4 / 10) + 0.0) : SetPedHeadOverlay(playerPed, 12, this.character.bodyb_3, (this.character.bodyb_4 / 10) + 0.0)
		this.character.ears_1 === -1 ? ClearPedProp(playerPed, 2) : SetPedPropIndex(playerPed, 2, this.character.ears_1, this.character.ears_2, true)
		...
		this.character.helmet_1 === -1 ? ClearPedProp(playerPed, 0) : SetPedPropIndex(playerPed, 0,	this.character.helmet_1, this.character.helmet_2, true)	
		this.character.glasses_1 === -1 ? ClearPedProp(playerPed, 1) : SetPedPropIndex(playerPed, 1, this.character.glasses_1, this.character.glasses_2, true)
		this.character.watches_1 === -1 ? ClearPedProp(playerPed, 6) : SetPedPropIndex(playerPed, 6, this.character.watches_1, this.character.watches_2, true)
		this.character.bracelets_1 === -1 ? ClearPedProp(playerPed,	7) : SetPedPropIndex(playerPed, 7, this.character.bracelets_1, this.character.bracelets_2, true)
	}
	...
	getMaxVals() : ISkin {
		...
		return {
			...
			bracelets_2 : GetNumberOfPedPropTextureVariations(playerPed, 7, this.character['bracelets_1'] - 1)
		}
	}
	loadSkin(skin : ISkin, cb : () => void) : void {
		console.log(skin);
		cb()
	}
}
